...
public class Sub_SubCategoryWiseProductListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        cost_id = SharedPref.getVal(Sub_SubCategoryWiseProductListActivity.this, SharedPref.customer_id);
        onClick();
    ...
    private void init() {
        ...
        rec_subcategory.setVisibility(GONE);
...
//                            subscribed();
                            Intent intent = new Intent(Sub_SubCategoryWiseProductListActivity.this, SubscriptionCartActivity.class);
...
//                getProductList();
        ...
        rel_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Sub_SubCategoryWiseProductListActivity.this, OffersActivity.class));
//                finish();
            }
        });
        ...
        rel_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cost_id.equals("")) {
                    AlertDialog.Builder alertDialog = new AlertDialog.Builder(Sub_SubCategoryWiseProductListActivity.this);
                    ...
                    alertDialog.setPositiveButton("LOGIN", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent = new Intent(Sub_SubCategoryWiseProductListActivity.this, LoginActivity.class);
        ...
        rel_account.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Sub_SubCategoryWiseProductListActivity.this, CategoriesActivity.class));
            }
        });
...
//                            rec_list.setHasFixedSize(true);
            ...
            dismissDialog();
            final Dialog dialog = new Dialog(Sub_SubCategoryWiseProductListActivity.this);
    ...
    public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ViewHolder> implements Filterable {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public void bind(final ProductModel model, final int position) {
                Glide.with(Sub_SubCategoryWiseProductListActivity.this).
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if (status.equals("1")) {
                                    qty = 0;
//                                    getProductList();
                                    Toast.makeText(Sub_SubCategoryWiseProductListActivity.this, "Item removed from cart successfully", Toast.LENGTH_SHORT).show();
                                    cartCount();
                                   /* productId = new ArrayList<>();
                                    unitArrayList = new ArrayList<>();
                                    qtyArrayList = new ArrayList<>();
