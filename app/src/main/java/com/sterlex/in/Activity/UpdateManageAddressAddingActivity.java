...
//        }
    ...
    private void setData(AddressModel model) {
        ...
        edt_sector.setText(model.getSector_number());
    }
                    ...
                    try {
                        ...
                        if(status.equals("0")){
                            ...
                            /*new AlertDialog.Builder(UpdateManageAddressAddingActivity.this)
                                    ...
                                    .show();*/
                            Toast.makeText(UpdateManageAddressAddingActivity.this, "Currently we are not available in your area.", Toast.LENGTH_SHORT).show();
                        }else{
                            rel_check.setVisibility(View.VISIBLE);
                            ...
                            /*new AlertDialog.Builder(UpdateManageAddressAddingActivity.this)
                                    ...
                                    .show();*/
                            Toast.makeText(UpdateManageAddressAddingActivity.this, "We are available in your area.", Toast.LENGTH_SHORT).show();
                        }
                        dismissDialog();
                    } catch (JSONException e) {
                        dismissDialog();
...
//                    params.put("franchise_id", SharedPref.getVal(UpdateManageAddressAddingActivity.this, SharedPref.fran_code));
            ...
            dismissDialog();
            final Dialog dialog = new Dialog(UpdateManageAddressAddingActivity.this);
    ...
    public void city(View v) {
        Intent intent = new Intent(UpdateManageAddressAddingActivity.this, CircleSelectionActivity2.class);
