...
public class BestSellingProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        cost_id = SharedPref.getVal(BestSellingProductActivity.this, SharedPref.customer_id);
        onClick();
        getBestSelling();
    }

    private void init() {
        dialog = new IOSDialog.Builder(BestSellingProductActivity.this)
        ...
        rec_list.setLayoutManager(new LinearLayoutManager(BestSellingProductActivity.this));
        rec_subcategory.setLayoutManager(new LinearLayoutManager(BestSellingProductActivity.this, RecyclerView.HORIZONTAL, false));
    }
            ...
            public void onClick(View v) {
              ...
              /*  if(subscription_type.equals("customize")){
                ...
                if (strFromDate.equals("")) {
                    Toast.makeText(BestSellingProductActivity.this, "Please select from date", Toast.LENGTH_SHORT).show();
                } else if (strToDate.equals("")) {
                    Toast.makeText(BestSellingProductActivity.this, "Please select to date", Toast.LENGTH_SHORT).show();
                } else {
                    if (subscription_type.equals("Weekly")) {
                        if (weeklyDays.equals("")) {
                            Toast.makeText(BestSellingProductActivity.this, "Please select day", Toast.LENGTH_SHORT).show();
                        } else {
//                            subscribed();
                            Intent intent = new Intent(BestSellingProductActivity.this, SubscriptionAddressActivity.class);
                        ...
                        if (customizeDay.equals("")) {
                            Toast.makeText(BestSellingProductActivity.this, "Please select days", Toast.LENGTH_SHORT).show();
                        } else {
//                            subscribed();
                            Intent intent = new Intent(BestSellingProductActivity.this, SubscriptionAddressActivity.class);
                            intent.putExtra("from_date", strFromDate);
...
//                getProductList();
        ...
        rel_from.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final DatePickerDialog datePickerDialog = new DatePickerDialog(BestSellingProductActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        rel_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(BestSellingProductActivity.this, HomeActivity.class));
        ...
        rel_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(BestSellingProductActivity.this, OffersActivity.class));
//                finish();
            }
        });
        ...
        rel_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cost_id.equals("")) {
                    AlertDialog.Builder alertDialog = new AlertDialog.Builder(BestSellingProductActivity.this);
                    ...
                    alertDialog.setPositiveButton("LOGIN", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent = new Intent(BestSellingProductActivity.this, LoginActivity.class);
                    ...
                    startActivity(new Intent(BestSellingProductActivity.this, CartActivity.class));
                }
            }
        });
        ...
        rel_subscription.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cost_id.equals("")) {
                    ...
                    startActivity(new Intent(BestSellingProductActivity.this, SubscriptionActivity.class));
                }
            }
        });
        ...
        rel_account.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(BestSellingProductActivity.this, CategoriesActivity.class));
            }
        });
    ...
    public void account(View view) {
        startActivity(new Intent(BestSellingProductActivity.this, AccountActivity.class));
    }
...
//        dialog.show();
        ...
        if (APIURLs.isNetwork(BestSellingProductActivity.this)) {
            StringRequest stringRequest = new StringRequest(Request.Method.POST, APIURLs.best_selling_product, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    try {
                        ...
                        if (status.equals("1")) {
                            ...
                            ProductAdapter adapter = new ProductAdapter(BestSellingProductActivity.this);
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("customer_id", SharedPref.getVal(BestSellingProductActivity.this, SharedPref.customer_id));
                    return params;
                }
            };
            ...
            dismissDialog();
            final Dialog dialog = new Dialog(BestSellingProductActivity.this);
    ...
    public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(BestSellingProductActivity.this).inflate(R.layout.search_item_layout, parent, false);
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public void bind(final ProductModel model, final int position) {
                Glide.with(BestSellingProductActivity.this).
...
*/
                ...
                lnr_product.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(new Intent(BestSellingProductActivity.this, ProductDetailsActivity.class));
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if (status.equals("1")) {
                                    qty = 0;
//                                    getProductList();
                                    Toast.makeText(BestSellingProductActivity.this, "Item removed from cart successfully", Toast.LENGTH_SHORT).show();
                                    cartCount();
                                   /* productId = new ArrayList<>();
                                    unitArrayList = new ArrayList<>();
                                    qtyArrayList = new ArrayList<>();
                                   ...
                                   /* adapter.notifyDataSetChanged();
                                    ...
                                    Toast.makeText(BestSellingProductActivity.this, "Error", Toast.LENGTH_SHORT).show();
                                }
//                                dismissDialog();
...
//                            dismissDialog();
                    ...
                    RequestQueue requestQueue = Volley.newRequestQueue(BestSellingProductActivity.this);
                    stringRequest.setRetryPolicy(new DefaultRetryPolicy(50000, DefaultRetryPolicy.DEFAULT_MAX_RETRIES,
                            DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
                    requestQueue.add(stringRequest);
                } else {
...
//                    dismissDialog();
                    ...
                    button.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            addCart(prod_id, unit, price, discount, qty1, position);
                            dialog.dismiss();
                        }
                    });
                    dialog.show();
