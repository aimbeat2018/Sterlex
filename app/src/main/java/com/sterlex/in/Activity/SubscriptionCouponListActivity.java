...
public class SubscriptionCouponListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        cost_id = SharedPref.getVal(SubscriptionCouponListActivity.this, SharedPref.customer_id);
        onClick();
//        getCouponList();
    }
...
//        dialog.show();
        ...
        if (APIURLs.isNetwork(SubscriptionCouponListActivity.this)) {
            ...
            dismissDialog();
            final Dialog dialog = new Dialog(SubscriptionCouponListActivity.this);
