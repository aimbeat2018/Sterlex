...
public class HotProductListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        cost_id = SharedPref.getVal(HotProductListActivity.this, SharedPref.customer_id);
        sub_cat_id = getIntent().getStringExtra("sub_cat_id");
        txt_categoryName.setText("Hot Product List");
        onClick();
        getsubProductList();
    }

    private void init() {
        dialog = new IOSDialog.Builder(HotProductListActivity.this)
        ...
        rec_list.setLayoutManager(new LinearLayoutManager(HotProductListActivity.this));
        rec_subcategory.setLayoutManager(new LinearLayoutManager(HotProductListActivity.this, RecyclerView.HORIZONTAL, false));
    }
            ...
            public void onClick(View v) {
              ...
              /*  if(subscription_type.equals("customize")){
                ...
                if (strFromDate.equals("")) {
                    Toast.makeText(HotProductListActivity.this, "Please select from date", Toast.LENGTH_SHORT).show();
                } else if (strToDate.equals("")) {
                    Toast.makeText(HotProductListActivity.this, "Please select to date", Toast.LENGTH_SHORT).show();
                } else {
                    if (subscription_type.equals("Weekly")) {
                        if (weeklyDays.equals("")) {
                            Toast.makeText(HotProductListActivity.this, "Please select day", Toast.LENGTH_SHORT).show();
                        } else {
//                            subscribed();
                            Intent intent = new Intent(HotProductListActivity.this, SubscriptionAddressActivity.class);
                        ...
                        if (customizeDay.equals("")) {
                            Toast.makeText(HotProductListActivity.this, "Please select days", Toast.LENGTH_SHORT).show();
                        } else {
//                            subscribed();
                            Intent intent = new Intent(HotProductListActivity.this, SubscriptionAddressActivity.class);
                            intent.putExtra("from_date", strFromDate);
...
//                getProductList();
        ...
        rel_from.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final DatePickerDialog datePickerDialog = new DatePickerDialog(HotProductListActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        rel_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(HotProductListActivity.this, HomeActivity.class));
        ...
        rel_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(HotProductListActivity.this, OffersActivity.class));
//                finish();
            }
        });
        ...
        rel_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cost_id.equals("")) {
                    AlertDialog.Builder alertDialog = new AlertDialog.Builder(HotProductListActivity.this);
                    ...
                    alertDialog.setPositiveButton("LOGIN", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent = new Intent(HotProductListActivity.this, LoginActivity.class);
                    ...
                    startActivity(new Intent(HotProductListActivity.this, CartActivity.class));
                }
            }
        });
        ...
        rel_subscription.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cost_id.equals("")) {
                    ...
                    startActivity(new Intent(HotProductListActivity.this, SubscriptionActivity.class));
                }
            }
        });
        ...
        rel_account.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(HotProductListActivity.this, CategoriesActivity.class));
            }
        });
    ...
    public void account(View view) {
        startActivity(new Intent(HotProductListActivity.this, AccountActivity.class));
    }
...
//        dialog.show();
        ...
        if (APIURLs.isNetwork(HotProductListActivity.this)) {
                    ...
                    try {
                        ...
                        if (status.equals("1")) {
                          ...
                          /*  productId = new ArrayList<>();
                            ...
                            adapter = new ProductAdapter(HotProductListActivity.this);
...
//                            rec_list.setHasFixedSize(true);
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("customer_id", SharedPref.getVal(HotProductListActivity.this, SharedPref.customer_id));
            ...
            dismissDialog();
            final Dialog dialog = new Dialog(HotProductListActivity.this);
    ...
    public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(HotProductListActivity.this).inflate(R.layout.search_item_layout, parent, false);
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public void bind(final ProductModel model, final int position) {
                Glide.with(HotProductListActivity.this).
...
*/
                ...
                lnr_product.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(new Intent(HotProductListActivity.this, ProductDetailsActivity.class));
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if (status.equals("1")) {
                                    qty = 0;
//                                    getProductList();
                                    Toast.makeText(HotProductListActivity.this, "Item removed from cart successfully", Toast.LENGTH_SHORT).show();
                                    cartCount();
                                   /* productId = new ArrayList<>();
                                    unitArrayList = new ArrayList<>();
                                    qtyArrayList = new ArrayList<>();
                                   ...
                                   /* adapter.notifyDataSetChanged();
                                    ...
                                    Toast.makeText(HotProductListActivity.this, "Error", Toast.LENGTH_SHORT).show();
                                }
//                                dismissDialog();
...
//                            dismissDialog();
                    ...
                    RequestQueue requestQueue = Volley.newRequestQueue(HotProductListActivity.this);
                    stringRequest.setRetryPolicy(new DefaultRetryPolicy(50000, DefaultRetryPolicy.DEFAULT_MAX_RETRIES,
                            DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
                    requestQueue.add(stringRequest);
                } else {
                    dismissDialog();
                    FunctionConstant.noInternetDialog(HotProductListActivity.this, "no internet connection");
                }
            }
